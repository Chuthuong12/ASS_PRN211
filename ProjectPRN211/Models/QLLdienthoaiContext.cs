...
{
    public partial class QLLdienthoaiContext : DbContext
    {
        public QLLdienthoaiContext()
        {
        }

        public QLLdienthoaiContext(DbContextOptions<QLLdienthoaiContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Sanpham>(entity =>
            {
                ...
                entity.HasOne(d => d.MahdhNavigation)
                    .WithMany(p => p.Sanphams)
